...
var metrics = [{
    ...
    var metric = new prometheus.Gauge(it);
...
var router = new koa_router_1.default()
    .get('/metrics', function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    ...
    .post('/collect', function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        registry.getSingleMetric(ctx.params.);
        return [2 /*return*/];
    });
}); });
